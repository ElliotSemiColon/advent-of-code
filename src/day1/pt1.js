...
for(let i = 0; i < array.length-1; i++){
    for(x = 0; x < array.length-1; x++){
        if(parseInt(array[i])+parseInt(array[x]) == 2020){
            answer = parseInt(array[i])*parseInt(array[x]);
            x = 2000;
            i = 2000;
        }
        console.log(`i:${i} x:${x}`)
...
if(answer){
    console.log(`loop done, answer ${answer}`);
}else{
